...
import com.tfkz.tfkz2_0.pojo.pay.BizContent;
import com.tfkz.tfkz2_0.pojo.pay.PGoodsDetail;
import com.tfkz.tfkz2_0.pojo.vo.*;
...
public class POJOtoVOUtils {
    ...
    public static BizContent getBizContent(Order order, List<OrderItem> orderItems){
        ...
        String subject = "同福客栈在线平台"+order.getPayment();
