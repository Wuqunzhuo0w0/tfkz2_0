...
import com.tfkz.tfkz2_0.mapper.*;
import com.tfkz.tfkz2_0.pojo.*;
import com.tfkz.tfkz2_0.pojo.pay.Configs;
import com.tfkz.tfkz2_0.pojo.pay.ZxingUtils;
import com.tfkz.tfkz2_0.pojo.vo.CartOrderItemVO;
import com.tfkz.tfkz2_0.pojo.vo.OrderItemVO;
import com.tfkz.tfkz2_0.pojo.vo.OrderVO;
import com.tfkz.tfkz2_0.service.IOrderService;
import com.tfkz.tfkz2_0.utils.*;
...
public class OrderServiceImpl implements IOrderService {
    ...
    private Order getNewOrder(Integer uid, Integer shippingId, BigDecimal orderTotalPrice, Long orderNo) {
        ...
        if (insert > 0) {
            System.out.println("insert进入order的个数为-------------"+insert);
            return order;
        }
        return null;
    }
    ...
    public ServerResponse createNew(HttpSession session, Integer shippingId) {
        ...
        System.out.println(liCarts.size()+".......listCart的size.......");
        //判断购物信息是否存在
        ...
        System.out.println(newOrder.getUserId()+"-----------------------neworder的uid=");
...
//            String filePath = new StringBuilder(basePath).append(fileName).toString();
            ...
            if (response.isSuccess()) {
                ...
                String newFilePath = String.format("QRCode/"+"qr-%s.png",
                        response.getOutTradeNo());
